  ...
  render() {
    ...
    return (
      <div className="px-10 page-container">
        <div className=" flex items-center mt-5 w-full max-w-[20px] ml-auto ">
          ...
          <span className="absolute top-0 flex items-center justify-center w-8 h-8 text-xl text-white bg-red-400 rounded-full">
            3
          </span>
        </div>
