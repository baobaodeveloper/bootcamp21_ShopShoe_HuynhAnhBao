...
const mapStateToProps = (state) => {
  return {
    ...
    shopCard: state.shoeReducer.shopCard,
  };
};
    ...
    return (
      <div className="px-10 page-container">
        <div className="relative flex items-center mt-5 w-full max-w-[20px] ml-auto ">
          ...
          <span className="absolute flex items-center justify-center w-8 h-8 text-xl text-white bg-red-400 rounded-full -right-8 -top-4">
            {this.props.shopCard.length}
          </span>
        </div>
        ...
        <ProductShopCard shopCard={this.props.shopCard}></ProductShopCard>
      </div>
    );
  }
}
